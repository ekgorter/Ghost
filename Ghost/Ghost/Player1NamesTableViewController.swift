...
//  Ghost
//
//  Created by Elias Gorter on 13-05-15.
...
protocol Player1NamesTableViewControllerDelegate {
    func setName1(controller: Player1NamesTableViewController, name: String)
}

class Player1NamesTableViewController: UITableViewController {
    
    var defaults: NSUserDefaults = NSUserDefaults.standardUserDefaults()
    var playerNames: [String]!
    
    var delegate: Player1NamesTableViewControllerDelegate? = nil
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if let text = text {
            delegate?.setName1(self, name: text)
        }
